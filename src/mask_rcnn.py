...
from torchvision.models.detection.mask_rcnn import MaskRCNN as torchvision_MaskRCNN
...
class MaskRCNN(LightningModule):
    def __init__(
        ...
        **kwargs: Any,
        ...
        backbone_model = create_resnet_backbone(
            self.backbone,
            trainable_backbone_layers,
            **kwargs,
        )

        self.model = torchvision_MaskRCNN(
...
def main():
    ...
    parser = MaskRCNN.add_argparse_args(parser)
    ...
    model = MaskRCNN.from_argparse_args(args)
